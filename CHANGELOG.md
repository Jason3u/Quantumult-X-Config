...
## 2026-09-06（六）· 订阅切换良心云（仅 QX，Clash 不动）

- 订阅源吹雪云 → 良心云（tag=良心云），吹雪云 URL 注释保留备用
- 良心云为 QX 原生节点格式，去掉 opt-parser；含 5 个香港住宅IP节点，香港住宅IP 组不再为空
- Telegram固定节点 / Cornix固定节点 的 resource-tag-regex 同步改为 `^良心云$`
- 注意：良心云暂无台湾/韩国节点，台湾节点/韩国节点组为空（不影响其他策略组正常使用）
